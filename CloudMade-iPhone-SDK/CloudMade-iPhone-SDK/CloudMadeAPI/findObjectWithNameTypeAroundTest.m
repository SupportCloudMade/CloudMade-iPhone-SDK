...
#import "findObjectWithNameTypeAroundTest.h"
...
@interface findObjectWithNameTypeAroundTest (private)
...
@implementation findObjectWithNameTypeAroundTest

- (void) testFindObjectWithNameTypeAround {
	...
	NSString* citiesTestSetstring = [NSString stringWithString:@"Kempten, nil"];
	...
	NSString* countiesTestSetstring = [NSString stringWithString:@"Bayern, nil"];
	...
	NSString* streetsTestSetstring = [NSString stringWithString:@"Pfeilergraben, nil"];
	...
	NSString* objectsTestSetString = [NSString stringWithString:@"cafe, nil"];
	NSMutableArray * objectsTestSet = [[NSMutableArray alloc] initWithArray:[objectsTestSetString componentsSeparatedByString:@", "]];
	...
	int numberOfCases = numberOfCasesForSearchParameters*numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForObjectNames;
	...
	for (index = 0; index < numberOfCases; index++) {
		...
		NSString* tempBboxOnlyCase = [bboxOnlyTestSet objectAtIndex:div(div(index,numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForObjectNames/[bboxOnlyTestSet count]).quot,[bboxOnlyTestSet count]).rem];
		...
		NSString* tempreturnLocationCase = [returnLocationTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForObjectNames/[bboxOnlyTestSet count]/[returnLocationTestSet count]).quot,[returnLocationTestSet count]).rem];
		...
		NSString* tempreturnGeometryCase = [returnGeometryTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForObjectNames/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]).quot,[returnGeometryTestSet count]).rem];
		...
		NSString* tempdistanceCase = [distanceTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForObjectNames/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]/[distanceTestSet count]).quot,[distanceTestSet count]).rem];
		...
		NSString* tempskipCase = [skipTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForObjectNames/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]/[distanceTestSet count]/[skipTestSet count]).quot,[skipTestSet count]).rem];
		...
		NSString* tempreturnResultsCase = [returnResultsTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForObjectNames/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]/[distanceTestSet count]/[skipTestSet count]/[returnResultsTestSet count]).quot,[returnResultsTestSet count]).rem];
		...
		STAssertNotNil(objectsTestSet, @"objectsTestSet is nil");
		objectTypes =  [[objectsTestSet objectAtIndex:div(div(index, numberOfCasesForObjects*numberOfCasesForObjectNames/[objectsTestSet count]).quot,[objectsTestSet count]).rem] retain];
		...
		objectNames =  [[objectNamesTestSet objectAtIndex:div(div(index, numberOfCasesForObjectNames/[objectNamesTestSet count]).quot,[objectNamesTestSet count]).rem] retain];
		...
		[_geocoder findObjectsWithName:objectNames type:objectTypes around:searchParameters];
