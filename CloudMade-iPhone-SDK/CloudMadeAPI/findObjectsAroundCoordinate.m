...
#import "findObjectsAroundCoordinate.h"
...
@interface findObjectsAroundCoordinate (private)
...
@implementation findObjectsAroundCoordinate
...
- (void) testFindObjectsAroundCoordinate {
	...
	int numberOfCases = numberOfCasesForGeocoderParameters*numberOfCasesForObjects*numberOfCasesForPoints;
	...
	for (index = 0; index < numberOfCases; index++) {
		...
		objectTypes =  [[objectsTestSet objectAtIndex:div(div(index, numberOfCasesForObjects*numberOfCasesForPoints/[objectsTestSet count]).quot,[objectsTestSet count]).rem] retain];
		...
		[_geocoder findObjects:objectTypes aroundCoordinate:point];
