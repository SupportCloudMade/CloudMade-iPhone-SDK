...
#import "findObjectsAroundTest.h"
...
@interface findObjectsAroundTest (private)
...
@implementation findObjectsAroundTest

- (void) testfindFindObjectsAround {
	...
	NSString* objectsTestSetStrung = [NSString stringWithString:@"parking, nil"];
	...
	int numberOfCases = numberOfCasesForSearchParameters*numberOfCasesForGeocoderParameters*numberOfCasesForObjects;
	...
	for (index = 0; index < numberOfCases; index++) {
		...
		NSString* tempBboxOnlyCase = [bboxOnlyTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects/[bboxOnlyTestSet count]).quot,[bboxOnlyTestSet count]).rem];
		...
		NSString* tempreturnLocationCase = [returnLocationTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects/[bboxOnlyTestSet count]/[returnLocationTestSet count]).quot,[returnLocationTestSet count]).rem];
		...
		NSString* tempreturnGeometryCase = [returnGeometryTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]).quot,[returnGeometryTestSet count]).rem];
		...
		NSString* tempdistanceCase = [distanceTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]/[distanceTestSet count]).quot,[distanceTestSet count]).rem];
		...
		NSString* tempskipCase = [skipTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]/[distanceTestSet count]/[skipTestSet count]).quot,[skipTestSet count]).rem];
		...
		NSString* tempreturnResultsCase = [returnResultsTestSet objectAtIndex:div(div(index, numberOfCasesForGeocoderParameters*numberOfCasesForObjects/[bboxOnlyTestSet count]/[returnLocationTestSet count]/[returnGeometryTestSet count]/[distanceTestSet count]/[skipTestSet count]/[returnResultsTestSet count]).quot,[returnResultsTestSet count]).rem];
		...
		objectTypes =  [[objectsTestSet objectAtIndex:div(div(index, numberOfCasesForObjects/[objectsTestSet count]).quot,[objectsTestSet count]).rem] retain];
		
		
		_geocoder.requestParameters = searchRequestParameters;
		
		
		[_geocoder find:objectTypes around:searchParameters];
